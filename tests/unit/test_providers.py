...
from compcopilot.errors import ProviderError, TransientProviderError
from compcopilot.logging_setup import JsonFormatter, RedactingTextFormatter, configure_logging
from compcopilot.providers import AnthropicChatClient, OpenAIChatClient
...
class TestLogging:
    def _record(self, message: str, **extra: object) -> logging.LogRecord:
        record = logging.LogRecord(
            "compcopilot.t", logging.WARNING, __file__, 1, message, None, None
        )
    ...
    def test_configure_logging_is_idempotent(self, as_json: bool) -> None:
        root = logging.getLogger("compcopilot")
